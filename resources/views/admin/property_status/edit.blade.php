...
@section('title') Edit {{ $property_status->property_status_name }} @stop
...
<div class="container-fluid">
	<div class="panel panel-default">
		...
		@endif
			<form action="{{ route('property_status.update', ['property_status' => $property_status]) }}" class="form-horizontal"
				...
				<div class="form-group required">
					<div class="col-md-12">
						...
						<input status="text" class="form-control" required 
								...
								value="{{ $property_status->property_status_name }}" 
						>
					</div> <!-- /.col-md-12 -->
				...
				<div class="form-group">
					<div class="col-md-12">
						...
						<textarea name="property_status_description" id="property_status_description" 
							...
							>{{ $property_status->property_status_description }}</textarea>
					</div>
				</div>  <!-- /.form-group required -->
				<div class="form-group">
					<div class="col-md-12">
